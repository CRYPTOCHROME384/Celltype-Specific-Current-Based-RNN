...
class SelectivitySingleTrialLoss:
    ...
    def __call__(self, net, rates_data, rates_model):
        ...
        #projections model
        proj_sample_model = rates_model @ net_sample_alm.T
        proj_delay_model = rates_model @ net_delay_alm.T
        proj_choice_model = rates_model @ net_choice_alm.T
        ...
        print(proj_choice_data.shape, proj_choice_model.shape)
